...
namespace Google.YouTube.Player {
	...
	public sealed partial class YouTubeInitializationResult : global::Java.Lang.Enum {
		...
		public static global::Google.YouTube.Player.YouTubeInitializationResult ClientLibraryUpdateRequired {
			get {
				const string __id = "CLIENT_LIBRARY_UPDATE_REQUIRED.Lcom/google/android/youtube/player/YouTubeInitializationResult;";

				var __v = _members.StaticFields.GetObjectValue (__id);
				return global::Java.Lang.Object.GetObject<global::Google.YouTube.Player.YouTubeInitializationResult> (__v.Handle, JniHandleOwnership.TransferLocalRef);
			}
		}
		...
		public static global::Google.YouTube.Player.YouTubeInitializationResult DeveloperKeyInvalid {
			get {
				const string __id = "DEVELOPER_KEY_INVALID.Lcom/google/android/youtube/player/YouTubeInitializationResult;";
		...
		public static global::Google.YouTube.Player.YouTubeInitializationResult ErrorConnectingToService {
			get {
				const string __id = "ERROR_CONNECTING_TO_SERVICE.Lcom/google/android/youtube/player/YouTubeInitializationResult;";
		...
		public static global::Google.YouTube.Player.YouTubeInitializationResult InternalError {
			get {
				const string __id = "INTERNAL_ERROR.Lcom/google/android/youtube/player/YouTubeInitializationResult;";
		...
		public static global::Google.YouTube.Player.YouTubeInitializationResult InvalidApplicationSignature {
			get {
				const string __id = "INVALID_APPLICATION_SIGNATURE.Lcom/google/android/youtube/player/YouTubeInitializationResult;";
		...
		public static global::Google.YouTube.Player.YouTubeInitializationResult NetworkError {
			get {
				const string __id = "NETWORK_ERROR.Lcom/google/android/youtube/player/YouTubeInitializationResult;";
		...
		public static global::Google.YouTube.Player.YouTubeInitializationResult ServiceDisabled {
			get {
				const string __id = "SERVICE_DISABLED.Lcom/google/android/youtube/player/YouTubeInitializationResult;";
		...
		public static global::Google.YouTube.Player.YouTubeInitializationResult ServiceInvalid {
			get {
				const string __id = "SERVICE_INVALID.Lcom/google/android/youtube/player/YouTubeInitializationResult;";
		...
		public static global::Google.YouTube.Player.YouTubeInitializationResult ServiceMissing {
			get {
				const string __id = "SERVICE_MISSING.Lcom/google/android/youtube/player/YouTubeInitializationResult;";
		...
		public static global::Google.YouTube.Player.YouTubeInitializationResult ServiceVersionUpdateRequired {
			get {
				const string __id = "SERVICE_VERSION_UPDATE_REQUIRED.Lcom/google/android/youtube/player/YouTubeInitializationResult;";
		...
		public static global::Google.YouTube.Player.YouTubeInitializationResult Success {
			get {
				const string __id = "SUCCESS.Lcom/google/android/youtube/player/YouTubeInitializationResult;";
		...
		public static global::Google.YouTube.Player.YouTubeInitializationResult UnknownError {
			get {
				const string __id = "UNKNOWN_ERROR.Lcom/google/android/youtube/player/YouTubeInitializationResult;";

				var __v = _members.StaticFields.GetObjectValue (__id);
				return global::Java.Lang.Object.GetObject<global::Google.YouTube.Player.YouTubeInitializationResult> (__v.Handle, JniHandleOwnership.TransferLocalRef);
			}
		}
		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/google/android/youtube/player/YouTubeInitializationResult", typeof (YouTubeInitializationResult));
		...
		public unsafe bool IsUserRecoverableError {
			...
			get {
				const string __id = "isUserRecoverableError.()Z";
				try {
		...
		{
			const string __id = "getErrorDialog.(Landroid/app/Activity;I)Landroid/app/Dialog;";
			try {
		...
		{
			const string __id = "getErrorDialog.(Landroid/app/Activity;ILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;";
			try {
		...
		public static unsafe global::Google.YouTube.Player.YouTubeInitializationResult ValueOf (string p0)
		{
			const string __id = "valueOf.(Ljava/lang/String;)Lcom/google/android/youtube/player/YouTubeInitializationResult;";
			IntPtr native_p0 = JNIEnv.NewString (p0);
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [1];
				__args [0] = new JniArgumentValue (native_p0);
				var __rm = _members.StaticMethods.InvokeObjectMethod (__id, __args);
				return global::Java.Lang.Object.GetObject<global::Google.YouTube.Player.YouTubeInitializationResult> (__rm.Handle, JniHandleOwnership.TransferLocalRef);
			} finally {
		...
		public static unsafe global::Google.YouTube.Player.YouTubeInitializationResult[] Values ()
		{
			const string __id = "values.()[Lcom/google/android/youtube/player/YouTubeInitializationResult;";
			try {
				var __rm = _members.StaticMethods.InvokeObjectMethod (__id, null);
				return (global::Google.YouTube.Player.YouTubeInitializationResult[]) JNIEnv.GetArray (__rm.Handle, JniHandleOwnership.TransferLocalRef, typeof (global::Google.YouTube.Player.YouTubeInitializationResult));
			} finally {
			}
		}
