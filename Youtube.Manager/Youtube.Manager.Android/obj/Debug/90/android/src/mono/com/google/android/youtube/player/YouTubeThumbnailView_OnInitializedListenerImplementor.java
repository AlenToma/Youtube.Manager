...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Google.YouTube.Player.YouTubeThumbnailView+IOnInitializedListenerImplementor, YouTubeApi", YouTubeThumbnailView_OnInitializedListenerImplementor.class, __md_methods);
	}
	...
	public YouTubeThumbnailView_OnInitializedListenerImplementor ()
	{
		...
		if (getClass () == YouTubeThumbnailView_OnInitializedListenerImplementor.class)
			mono.android.TypeManager.Activate ("Google.YouTube.Player.YouTubeThumbnailView+IOnInitializedListenerImplementor, YouTubeApi", "", this, new java.lang.Object[] {  });
	}
