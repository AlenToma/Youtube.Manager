...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "Youtube.Manager.Android.dll" comes first in this list. */
		"Youtube.Manager.Android.dll",
		"Acr.UserDialogs.dll",
		"AndHUD.dll",
		...
		"Youtube.Manager.dll",
		"Youtube.Manager.Models.Container.dll",
		"YouTubeApi.dll",
		"EntityWorker.Core.dll",
		"YoutubeExplode.dll",
	};
