...
namespace Realm.Of.Y.Manager.Droid.Models
{
    public class VideoViewRenderer : ViewRenderer<LocalVideoView, ARelativeLayout>, IDisposable
    {
        ...
        public void BindEvents()
        {
            ...
            element.GetCurrentMedia = () => MediaPlayer.MediaQueue.Current != null ? new Realm.Of.Y.Manager.Models.Container.MediaItem(MediaPlayer.MediaQueue.Current.MediaUri) { Title = MediaPlayer.MediaQueue.Current.Title } : null;
        ...
        public async void PlayVideo(Realm.Of.Y.Manager.Models.Container.MediaItem[] videos)
        {
